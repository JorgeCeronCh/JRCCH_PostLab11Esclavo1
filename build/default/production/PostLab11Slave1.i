...
# 24 "PostLab11Slave1.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\include\\c90\\stdint.h" 1 3
# 25 "PostLab11Slave1.c" 2
...
# 28 "PostLab11Slave1.c" 2
# 37 "PostLab11Slave1.c"
...
void __attribute__((picinterrupt(("")))) isr (void){
    if(PIR1bits.SSPIF){
        val_temporal = SSPBUF;
        CCPR = map(val_temporal, 0, 255, 62, 125);
